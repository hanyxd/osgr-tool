...
public final class Utils {
	private static final Color[] JOE_BIDEN = {
			new Color(120, 20, 230),			new Color(160, 60, 255),			new Color(130, 50, 255),			new Color(100, 140, 255),			new Color(72, 126, 255),			new Color(64, 170, 255),			new Color(120, 80, 250),			new Color(160, 100, 255),			new Color(190, 120, 255),			new Color(120, 20, 230)	};
	...
	public static Color getMainColor(int alpha, int unusedIncrement) {
		...
		try {
			if (ClickGUI.breathing.getValue()) {
				...
				int cycleDuration = 8000;				float progress = (currentTime % cycleDuration) / (float) cycleDuration;

				int colorCount = colors.length;
				if (colorCount == 0) return new Color(120, 20, 230, alpha);
